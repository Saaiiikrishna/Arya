...
export default function DashboardPage() {
  ...
  return (
    <div className="text-ink animate-fade-in px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-[1200px] 3xl:max-w-[1600px] mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="xl:col-span-8 flex flex-col gap-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              <Link href="/admin/questions" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
              ...
              <Link href="/admin/batches" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/training" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/analytics" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/referrals" className="border border-hairline p-5 bg-white hover:border-terracotta-warm transition-all group flex flex-col border-l-4 border-l-terracotta-warm/30">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/equity" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col border-l-4 border-l-forest/30">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/interviews" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/donations" className="border border-hairline p-5 bg-white hover:border-terracotta-warm transition-all group flex flex-col border-l-4 border-l-terracotta-warm/30">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/mentors" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/cofounders" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
                  <span className="group-hover:scale-110 transition-transform text-ink/40 group-hover:text-forest"><Briefcase size={22} strokeWidth={1.5} /></span>
              ...
              <Link href="/admin/sprints" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/documentary" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
              ...
              <Link href="/admin/pitch" className="border border-hairline p-5 bg-white hover:border-forest transition-all group flex flex-col">
                <div className="flex items-center gap-3 mb-3">
        ...
        <div className="xl:col-span-4 flex flex-col gap-10">
          ...
          <section>
            ...
            <div className="bg-white border border-hairline p-6 font-sans">
              {activeBatch ? (
                <div className="flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <div className="h-2 bg-parchment w-full overflow-hidden">
                      <div
                  ...
                  <div className="pt-4 border-t border-hairline">
                    <Link href={`/admin/batches/${activeBatch.id}`} className="bg-saffron hover:bg-saffron-deep text-white transition-colors text-[10px] uppercase tracking-widest px-4 py-3 text-center block font-bold w-full">
                      Manage Manifest →
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center py-6 text-center">
                  ...
                  <Link href="/admin/batches" className="border border-forest text-forest hover:bg-forest hover:text-white transition-colors text-[10px] uppercase tracking-widest px-4 py-3 block text-center font-bold w-full">
          ...
          <section>
            ...
            <div className="bg-ink text-parchment p-6 border border-ink/80">
              <div className="flex flex-col gap-2">
                {Object.entries(stats.statusBreakdown).map(([status, count]) => (
                  <div key={status} className="flex items-center justify-between py-3 border-b border-ink/30 last:border-0 group">
                    ...
                    <span className="font-serif text-xl font-bold group-hover:text-white transition-colors bg-white/5 px-2 py-0.5">{count.toLocaleString()}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {user?.role === 'SUPER_ADMIN' && (
        <section className="mt-16 bg-white border border-terracotta/10 hover:border-terracotta/50 transition-all group p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
